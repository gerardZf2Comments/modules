...
class CommentControllerTest extends AbstractControllerTestCase
{
    ...
    public function serverArray()
    {
        return array('REDIRECT_APPLICATION_ENV' => 'development', 
                     ...
                     'HTTP_HOST' => 'moduleswdoctrine', 
                     'HTTP_CONNECTION' => 'keep-alive', 
                     'HTTP_CACHE_CONTROL' => 'max-age=0',
                     'HTTP_ACCEPT' => 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
                     'HTTP_USER_AGENT' => 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.66 Safari/537.36',
                     'HTTP_ACCEPT_ENCODING' => 'gzip,deflate,sdch',
                     'HTTP_ACCEPT_LANGUAGE' => 'en-US,en;q=0.8', 
                     'HTTP_COOKIE' => 'PHPSESSID=jkqkgt0kl6vgbcfo95kjrt40j0',
                     'PATH' => '/usr/local/bin:/usr/bin:/bin', 
                     'SERVER_SIGNATURE' => '2 (Ubuntu) Server at moduleswdoctrine Port 80', 
                     'SERVER_SOFTWARE' => 'Apache/2.2.22 (Ubuntu)', 
                     'SERVER_NAME' => 'moduleswdoctrine', 
                     'SERVER_ADDR' => '127.0.0.1', 
                     'SERVER_PORT' => '80',
                     'REMOTE_ADDR' => '127.0.0.1', 
                     'DOCUMENT_ROOT' => '/home/gerard/sites/modules.w.doctrine/modules.zendframework.com/public', 
                     'SERVER_ADMIN' => 'webmaster@localhost',
                     'SCRIPT_FILENAME' => '/home/gerard/sites/modules.w.doctrine/modules.zendframework.com/public/index.php', 
                     'REMOTE_PORT' => '44352',
                     'REDIRECT_URL' => '/comment/add-reply',
                     'GATEWAY_INTERFACE' => 'CGI/1.1', 
                     'SERVER_PROTOCOL' => 'HTTP/1.1', 
                     'REQUEST_METHOD' => 'GET', 
                     'QUERY_STRING' => '', 
                     'REQUEST_URI' => '/comment/add-reply',
                     'SCRIPT_NAME' => '/index.php', 
                     'PHP_SELF' => '/index.php', 
                     'REQUEST_TIME' => 1381541478,
        );
    }
